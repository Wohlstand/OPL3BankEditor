...
#ifndef FORMAT_KLM_IMPORTER_H
#define FORMAT_KLM_IMPORTER_H

#include "ffmt_base.h"

/**
 * @brief Import FM instruments from KLM format (from Mark Klem) from the Wacky Wheels game
 */
class KLM_Importer : public FmBankFormatBase
{
public:

...
#ifndef FORMAT_MISC_SGI_H
#define FORMAT_MISC_SGI_H

#include "ffmt_base.h"

/**
 * @brief Reader and Writer of the SGI format used by Adlib Tracker II
 */
class Misc_SGI final : public FmBankFormatBase
{
public:

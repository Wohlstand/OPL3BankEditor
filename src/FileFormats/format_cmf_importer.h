...
#ifndef FORMAT_CMF_IMPORTER_H
#define FORMAT_CMF_IMPORTER_H

#include "ffmt_base.h"

/**
 * @brief Import FM instruments from Creative Music Format
 */
class CMF_Importer : public FmBankFormatBase
{
public:
    CMF_Importer();
    ~CMF_Importer() = default;

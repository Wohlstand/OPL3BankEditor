...
#ifndef ADLIBTRACKER_H
#define ADLIBTRACKER_H

#include "ffmt_base.h"

/**
 * @brief Reader and Writer of the A2I/A2B formats used by Adlib Tracker II
 */
class AdLibTracker : public FmBankFormatBase
{
public:

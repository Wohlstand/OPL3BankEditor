...
sips -Z 128 $TYPE".iconset/icon_48x48.png" --out $TYPE".iconset/icon_128x128.png"
sips -Z 256 $TYPE".iconset/icon_48x48.png" --out $TYPE".iconset/icon_128x128@2x.png"
sips -Z 256 $TYPE".iconset/icon_48x48.png" --out $TYPE".iconset/icon_256x256.png"
